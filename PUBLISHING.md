...
> BioSKD is a free personal Progressive Web App that shows the user's biorhythm chart
...
> or delete calendar events. BioSKD has no backend server: calendar data is processed in the
...
> This video demonstrates how BioSKD (https://eins2019.github.io/bio-scheduler/) uses the
...
> 5. BioSKD never creates, edits, or deletes events, and never sends calendar data to any server.
>
...
1. "This is BioSKD, a personal biorhythm and schedule web app, at eins2019.github.io/bio-scheduler."
...
5. "BioSKD only reads events to display them. It never changes my calendar and never sends my
   data to any server."
